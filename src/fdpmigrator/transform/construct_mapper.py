...
class ConstructMapper:
    ...
    def apply(self):
        ...
        This is done by checking if any of the subjects in the graph match the URIs specified in the query_targets dictionary.
        ...
        if self.construct_query is None:
            ...
            for subject in subjects:
                for query_name, uris in self.query_targets.items():
                    if str(subject) in uris:
